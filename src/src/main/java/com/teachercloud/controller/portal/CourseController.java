...
public class CourseController {
    ...
    @ResponseBody
    public ServerResponse<List<Course>> getStudentCourse(HttpSession session, @RequestParam(value = "classId", defaultValue = "5163002641")Long classId, @RequestParam(value = "keyword", defaultValue = "")String keyword) {
        //获取session中的user对象
